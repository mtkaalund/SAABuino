...
void follow_me_home()
{
  // When the key is out and the driver door is open. 
  // When DICE pin 41 is pulsed, the DICE should keep the lights on for 20 - 50 seconds as normal.
...
void loop()
{
  // Driver door is open ( DICE_PIN_1 )
  // The Key is out ( DICE_PIN_7 )
  ...
  // The front wiper is on ( DICE_PIN_27 )
